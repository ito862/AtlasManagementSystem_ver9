    ...
    Route::namespace('Authenticated')->group(function () {
        ...
        Route::namespace('Calendar')->group(function () {
            Route::namespace('General')->group(function () {
                ...
                Route::get('/reserve/{part}/{date}', [CalendarController::class, 'reserveDetail'])->name('reserve.detail');
                Route::get('/calender', [CalendarController::class, 'show'])->name('calendar.general');
                ...
                Route::post('/reserve/cancel', [CalendarController::class, 'cancel'])->name('reserve.cancel');
            });
